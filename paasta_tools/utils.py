...
class InstanceConfig:
    ...
    def get_primary_docker_registry(self) -> str:
        return get_service_primary_docker_registry(self.service, self.soa_dir)
    ...
    def get_docker_url(self) -> str:
        ...
        """
        registry_uri = self.get_primary_docker_registry()
...
def get_service_specified_docker_registries(
    service: str,
    soa_dir: str = DEFAULT_SOA_DIR,
    ...
    try:
        ...
        if not primary:
            ...
            return system_config.get_primary_docker_registry()
...
def get_service_push_docker_registries(
    ...
    return get_service_specified_docker_registries(  # type: ignore
        service, soa_dir, system_config, False
    )


def get_service_primary_docker_registry(
    service: str,
    soa_dir: str = DEFAULT_SOA_DIR,
    system_config: Optional["SystemPaastaConfig"] = None,
) -> str:
    return get_service_specified_docker_registries(  # type: ignore
        service, soa_dir, system_config, True
    )
...
def build_docker_image_names(service: str) -> List[str]:
...
def build_docker_tags(service: str, upstream_git_commit: str) -> List[str]:
    ...
    """
    tags = []
    for docker_image_name in build_docker_image_names(service):
